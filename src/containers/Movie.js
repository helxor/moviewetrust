...
function renderMovie(id) {
 ...
 <MovieA>
  ...
  allow-scripts allow-top-navigation" scrolling="yes" src={`https://videospider.in/getvideo?key=JzAFyoTAtzAwVCXW&video_id=${id}`} width="800" height="400" frameborder="0" allowfullscreen></iframe>
</center>
</MovieA>
  );
}
